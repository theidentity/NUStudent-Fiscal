...
<body>
    ...
    <div class="text-center">
        <h1 class="text-warning"><br/><span style="color:#f46524">NU$</span><span class="text-info">tudent</span> Fiscal</h1>
        <h5><small class="text-secondary">An Intelligent Budget Recommendation System for NUS Students</small></h5>
    </div>
    <section class="container mx-auto">
        ...
        <div class="row">
            <div class="col-3">
                <div class="card text-center text-center" style="min-height:220px;">
                    <div class="card-header bg-dark text-white font-weight-bold text-uppercase">
                        Housing
                    </div>
                    <div class="card-block text-left" style="padding:5px;">
                        {{!HousingRecommendation}}
                    </div>
                </div>
                <div class="card-footer text-muted text-right" style="min-height:120px;">
            ...
            <div class="col-3">
                <div class="card text-center text-center" style="min-height:220px;">
                    ...
                    <div class="card-block text-justify" style="padding:5px;">
            ...
            <div class="col-3">
                <div class="card text-center text-right" style="min-height:220px;">
                    <div class="card-header bg-dark text-white font-weight-bold text-uppercase">
                        Travel
                    </div>
                    <div class="card-block text-justify" style="padding:5px;">
